!(function (e, t) {
  ...
  function Ke(e, t) {
    ...
    return function () {
      var t = arguments,
        ...
        a = Date.now();
      if (i || a - r > n)
        return o && (clearTimeout(o), (o = null)), (r = a), e.apply(null, arguments);
      o ||
  ...
  var et,
    ...
    ot = function (e) {
      ...
      if (
        ...
        (i && ce.isFunction(i) && (i = i(n)), i || (!1 !== i && Xe(n.url)))
      ) {
        var d = a && s && $e.read(s);
        d && u.set(a, d);
      }
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 6:
                      ...
                      if (
                        ((p = h.value), (e.t0 = r), (e.t1 = n), (e.t2 = st), !ArrayBuffer.isView(p))
                      ) {
                        e.next = 15;
                        break;
                      }
  ...
  jt.transitional = function (e, t, r) {
    ...
    return function (r, o, i) {
      if (!1 === e)
        throw new fe(n(o, ' has been removed' + (t ? ' in ' + t : '')), fe.ERR_DEPRECATED);
      return (
        t &&
          !kt[o] &&
          ((kt[o] = !0),
      ...
      return (
        y(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return Oe(
                Ye((e = Ze(this.defaults, e)).baseURL, e.url),
                e.params,
                e.paramsSerializer
              );
            },
